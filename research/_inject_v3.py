"""Inject v3 activities (quality-depth pass) — same pattern as v2 injector."""
import re
import json
from pathlib import Path

ROOT = Path(__file__).parent.parent
DRAFT = ROOT / "research" / "new_activities_v3.txt"
...
print(f"Extracted {len(blocks)} activity blocks from v3 draft")
...
print(f"Total activities after v3 injection: {total}")
...
for b in blocks:
    ...
    mapping["activities"][aid] = {
        ...
        "confidence": "high",
        "reason": "v3 — kapsam kalite turu; kalan tek-kapsamlı kazanımları ≥2'ye çıkarmak için çoklu-hedefli.",
    }

mapping["last_updated"] = "2026-04-10 (v3)"
